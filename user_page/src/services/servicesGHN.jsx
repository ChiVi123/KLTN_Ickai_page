...
const servicesGHN = {
    getProvince: async () => {
        try {
            const response = await requestGHN.get('master-data/province');
    ...
    getDistrict: async (id) => {
        try {
            const response = await requestGHN.get('master-data/district', {
    ...
    getWard: async (id) => {
        try {
            const response = await requestGHN.get('master-data/ward', {
